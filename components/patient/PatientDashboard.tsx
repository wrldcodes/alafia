    ...
    >
      ...
      <aside className="bg-teal-800 flex flex-col overflow-y-auto h-screen relative">
        ...
        <div className="mx-3 my-3.5 bg-white/7 border border-white/10 rounded-[14px] p-3.5">
          <div className="w-11 h-11 rounded-full bg-teal-600 flex items-center justify-center font-display text-[16px] text-white mb-2.5">
            AO
          </div>
        ...
        <p className="px-3 pt-3.5 pb-1 text-[10px] font-semibold text-white/25 tracking-[0.1em] uppercase">
          My health
        </p>
      ...
      <div className="flex flex-col h-screen overflow-hidden">
        <header className="flex items-center justify-between px-7 h-[62px] bg-white border-b border-sand-200 flex-shrink-0">
          <h1 className="font-display text-[19px] text-teal-900 tracking-[-0.2px]">
    ...
    <div>
      <div className="bg-teal-800 rounded-[24px] px-8 py-7 mb-5 flex items-center justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-display text-[26px] text-white tracking-[-0.3px] mb-1.5">
            Amaka Obi
          </h2>
          <p className="text-[13px] font-light text-white/50">
            You have 1 upcoming appointment this week.
          </p>
        </div>
        <div className="bg-white/10 border border-white/15 rounded-full px-4.5 py-2.5 text-center relative z-10">
          ...
          <p className="font-display text-[18px] text-white tracking-wide">
            ALF-002849
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border-[1.5px] border-teal-100 rounded-[18px] p-4.5 mb-5 flex items-center gap-4">
        ...
        <div className="flex-1">
          <p className="text-[11px] font-semibold text-teal-600 tracking-wide uppercase mb-0.5">
            Next appointment
          </p>
          <p className="text-[15px] font-medium text-slate-800 mb-0.5">
            General consultation — Dr. Bello
          </p>
          <p className="text-[12px] font-light text-slate-400">
            Wednesday, 2 April 2025 · 9:00 AM · Gbagada General Hospital
          </p>
        </div>
      ...
      <div className="bg-white border border-sand-200 rounded-[18px] overflow-hidden">
        <div className="flex items-center justify-between px-4.5 py-3.5 border-b border-sand-100">
          ...
          <button
            ...
            className="text-[12px] font-medium text-teal-600 bg-none border-none cursor-pointer hover:underline"
          >
            See all
          </button>
        </div>
        <div className="grid grid-cols-2 gap-3.5 p-4">
          {[
            {
              title: "Stay hydrated",
              desc: "Drink at least 8 glasses of water daily to keep your body functioning well.",
              color: "teal",
            },
            {
              title: "Malaria prevention",
              desc: "Use treated mosquito nets, especially for children and pregnant women.",
              color: "amber",
            },
          ].map(({ title, desc, color }) => (
            <div
              key={title}
              className="bg-white border border-sand-200 rounded-[14px] p-4.5 flex gap-3.5 cursor-pointer hover:shadow-[0_4px_20px_rgba(0,0,0,0.07)] hover:-translate-y-0.5 transition-all"
            >
              <div
                className={`w-9 h-9 rounded-[10px] flex items-center justify-center flex-shrink-0 ${color === "teal" ? "bg-teal-50" : "bg-amber-50"}`}
              >
                <Shield
                  size={16}
                  className={
                    color === "teal" ? "text-teal-600" : "text-amber-700"
                  }
                />
              </div>
              <div>
                ...
                <p className="text-[12px] font-light text-slate-400 leading-[1.6]">
                  {desc}
                </p>
              </div>
            </div>
  ...
  return (
    <div>
      ...
      {[
          ...
          items: [
            {
              ...
              meta: "9:00 AM · Dr. Bello · Gbagada General Hospital",
            ...
            },
            {
              ...
              meta: "10:00 AM · Dr. Adeyemi · Gbagada General Hospital",
          ...
          items: [
            {
              ...
              meta: "11:00 AM · Dr. Bello · Gbagada General Hospital",
            ...
            },
            {
              ...
              day: "5",
              title: "General consultation",
              meta: "9:30 AM · Dr. Adeyemi · Gbagada General Hospital",
              status: "completed" as const,
              past: true,
            },
          ],
        ...
        <div
          key={heading}
          className="bg-white border border-sand-200 rounded-[18px] overflow-hidden mb-4"
        >
          <div className="px-4.5 py-3.5 border-b border-sand-100">
            <p className="text-[14px] font-semibold text-slate-800">
              {heading}
            </p>
          </div>
          {items.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="flex items-center gap-3.5 px-4.5 py-3 border-b border-sand-50 last:border-0 hover:bg-sand-50 cursor-pointer transition-colors"
              >
                <div
                  className={`w-10.5 h-11.5 rounded-[10px] flex flex-col items-center justify-center flex-shrink-0 ${past ? "bg-sand-100 border border-sand-200" : "bg-teal-50 border border-teal-100"}`}
                >
                  <p
                    className={`text-[9px] font-semibold uppercase tracking-wide ${past ? "text-slate-400" : "text-teal-600"}`}
                  >
                    {item.month}
                  </p>
                  <p
                    className={`font-display text-[18px] leading-none ${past ? "text-slate-600" : "text-teal-800"}`}
                  >
                    {item.day}
                  </p>
                </div>
  ...
  const records = [
    {
      ...
      meta: "Lab results · Dr. Bello",
      date: "31 Mar 2025",
    },
    {
      title: "General consultation notes",
      meta: "Clinical notes · Dr. Adeyemi",
      date: "18 Mar 2025",
    },
    {
      title: "Blood pressure history",
      meta: "Vitals log · Dr. Bello",
      date: "12 Jan 2025",
    },
    {
      title: "Malaria test results",
      meta: "Lab results · Dr. Bello",
      date: "5 Feb 2025",
    },
  ];
    ...
    <div className="bg-white border border-sand-200 rounded-[18px] overflow-hidden">
      ...
      {records.map(({ title, meta, date }) => (
        ...
        >
          ...
          <p className="text-[12px] font-light text-slate-400 flex-shrink-0">
            {date}
          </p>
        </div>
      ))}
  ...
  const clinics = [
    {
      ...
      tags: ["General practice", "Lab", "Pharmacy"],
      isMine: true,
    },
    {
      ...
      tags: ["Community health", "Maternity", "Immunisation"],
    },
    {
      ...
      dist: "9.3 km",
      hours: "24 hours",
      tags: ["Emergency", "Surgery", "General practice"],
    },
  ];
  return (
    <div>
      <div className="flex gap-2.5 mb-5">
        <div className="flex-1 flex items-center gap-2.5 bg-white border border-sand-200 rounded-full px-4.5 py-2.5">
          ...
          <input
            placeholder="Search by clinic name, location or service…"
            className="border-none bg-transparent outline-none text-[14px] text-slate-800 placeholder-slate-300 w-full"
          />
        </div>
      </div>
      <div className="flex flex-col gap-3">
        {clinics.map(({ name, loc, dist, hours, tags, isMine }) => (
          <div
            key={name}
            className="bg-white border border-sand-200 rounded-[18px] p-4.5 flex items-start gap-4 hover:shadow-[0_4px_20px_rgba(0,0,0,0.07)] hover:border-teal-200 cursor-pointer transition-all"
          >
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-1.5 flex-wrap">
                {tags.map((t) => (
                  <span
                    key={t}
                    className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-teal-50 text-teal-700 border border-teal-100"
                  >
                    {t}
                  </span>
                ))}
...
function TipsView() {
  const tips = [
    ...
    {
      title: "Malaria prevention",
      desc: "Sleep under treated mosquito nets. Empty stagnant water nearby.",
      color: "amber",
    },
    {
      title: "Know your blood pressure",
      desc: "High BP often has no symptoms. Get checked regularly if over 35.",
      color: "earth",
    },
    {
      title: "Child immunisation",
      desc: "Keep your child's vaccination schedule up to date.",
      color: "blue",
    },
    {
      title: "Exercise regularly",
      desc: "30 minutes of walking daily reduces risk of heart disease and diabetes.",
      color: "teal",
    },
    {
      title: "Wash your hands",
      desc: "Handwashing with soap prevents cholera, typhoid, and other infections.",
      color: "amber",
    },
  ];
  return (
    <div className="grid grid-cols-2 gap-3.5">
      {tips.map(({ title, desc, color }) => (
        <div
          key={title}
          className="bg-white border border-sand-200 rounded-[18px] p-4.5 flex gap-3.5 hover:shadow-[0_4px_20px_rgba(0,0,0,0.07)] hover:-translate-y-0.5 cursor-pointer transition-all"
        >
          <div
            className={`w-9 h-9 rounded-[10px] flex items-center justify-center flex-shrink-0 ${color === "teal" ? "bg-teal-50" : color === "amber" ? "bg-amber-50" : color === "earth" ? "bg-earth-50" : "bg-blue-50"}`}
          >
            <Shield
              size={16}
              className={
  ...
  return (
    <div>
      <div className="bg-white border border-sand-200 rounded-[24px] p-6 mb-4 flex items-center gap-5">
        <div className="w-16 h-16 rounded-full bg-teal-700 flex items-center justify-center font-display text-[24px] text-white flex-shrink-0">
          AO
        </div>
        <div className="flex-1">
          <p className="font-display text-[22px] text-teal-900 mb-0.5">
            Amaka Obi
          </p>
          <p className="text-[13px] font-light text-slate-400">
            Patient ID: ALF-002849 · Enrolled Jan 2024
          </p>
          <div className="flex gap-2 mt-2">
            <span className="text-[11px] font-medium px-2.5 py-0.5 rounded-full bg-teal-50 text-teal-700 border border-teal-100">
              Active patient
            </span>
            <span className="text-[11px] font-medium px-2.5 py-0.5 rounded-full bg-earth-50 text-earth-600 border border-earth-200">
              Gbagada General Hospital
            </span>
          </div>
        </div>
        <button className="px-4 py-2 rounded-full border border-sand-200 bg-white text-[13px] font-medium text-slate-600 cursor-pointer hover:border-teal-200 hover:text-teal-700 transition-colors">
          Edit profile
        </button>
      </div>
      <div className="grid grid-cols-2 gap-4">
        {[
          ...
          <div
            key={title}
            className="bg-white border border-sand-200 rounded-[18px] p-5"
          >
            <p className="text-[12px] font-semibold text-teal-600 tracking-wide uppercase mb-3.5 pb-2 border-b border-sand-200">
              {title}
            </p>
