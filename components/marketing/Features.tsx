...
/**
 * Features — 3-card grid rendered from a mapped subset.
 */
  ...
  return (
    <div>
      ...
      >
        ...
        <p
          data-reveal="up"
          className="text-[15px] sm:text-[17px] font-light text-slate-400 leading-[1.7] sm:leading-[1.75] max-w-[500px] mb-9 sm:mb-14"
        >
          ...
          {features.map(({ icon: Icon, title, desc }, index) => (
            <div
              ...
              className={cn(
                ...
                "bg-white border border-sand-200 rounded-2xl p-6 sm:p-8",
