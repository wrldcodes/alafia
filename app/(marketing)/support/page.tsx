      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 max-w-xl text-[16px] leading-[1.8] text-slate-500">
            Use this page for account questions, enrollment help, or clinic
            onboarding support. If you are exploring the demo, the rest of the
            app is available from the main portal.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <section
              key={item.title}
              className="rounded-3xl border border-sand-200 bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.04)]"
            >
              <h2 className="font-display text-[22px] text-teal-900">
                {item.title}
              </h2>
        ...
        <div className="flex flex-col gap-3 rounded-[28px] border border-teal-100 bg-teal-50 px-6 py-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-[15px] text-teal-900">
              Return to the main portal or continue with enrollment.
            </p>
          </div>
          <div className="flex gap-3">
            <Link
              href="/"
              className="inline-flex items-center justify-center rounded-full border border-teal-200 px-5 py-2.5 text-[14px] font-medium text-teal-800 no-underline transition-colors hover:border-teal-300 hover:bg-white"
            >
              Home
            </Link>
            <Link
              href="/enroll"
              className="inline-flex items-center justify-center rounded-full bg-teal-700 px-5 py-2.5 text-[14px] font-medium text-white no-underline transition-colors hover:bg-teal-800"
            >
              Get started
            </Link>
          </div>
