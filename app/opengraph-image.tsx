      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: 30, fontWeight: 700, letterSpacing: '-0.03em' }}>Aláfíà</div>
            <div style={{ fontSize: 14, color: '#4e6c65', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 22, maxWidth: 880 }}>
          ...
          <div style={{ fontSize: 72, lineHeight: 1.02, fontWeight: 700, letterSpacing: '-0.06em', maxWidth: 900 }}>
            Connect patients to nearby care. Give clinics one place to manage everything.
          </div>
          <div style={{ fontSize: 26, lineHeight: 1.45, color: '#53716b', maxWidth: 820 }}>
            Enroll patients, manage appointments, and share records in a clean mobile-friendly portal.
          </div>
        </div>
